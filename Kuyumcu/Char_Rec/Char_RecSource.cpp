...
int Classify()
	...
	imgTrainingNumbers = cv::imread("E:/CppCodes/ML/Kuyumcu/Char_Rec/training_chars.png");          // read in training numbers image
...
int TrainAndTest()
		...
		cv::Mat matTestingNumbers = cv::imread("test2.png");            // read in the test numbers image
